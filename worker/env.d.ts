/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 044d9ebd014fce9dcdc4c939281e5975)
...
interface __BaseEnv_Env {
	...
	LOADER: WorkerLoader;
	AI: Ai;
	BETTER_AUTH_URL: "https://api.linkos.in";
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_API_KEY: string;
	ChatAgent: DurableObjectNamespace<import("./src/index").ChatAgent>;
	McpAgent: DurableObjectNamespace<import("./src/index").McpAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatAgent" | "McpAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_API_KEY">> {}
}
