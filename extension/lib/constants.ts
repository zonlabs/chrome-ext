...
export const MODELS_DATA: ModelEntry[] = [
  ...
  { value: '@cf/zai-org/glm-5.2',                           label: 'GLM 5.2',          desc: 'Zhipu AI flagship agentic coding model with reasoning & tools', icon: 'zai.svg', tier: 'advanced' },
  ...
  { value: '@cf/google/gemma-4-26b-a4b-it',                 label: 'Gemma 4 26B',      desc: 'Gemini 3 research-based model with function calling, reasoning & vision', icon: 'google.svg', tier: 'advanced', hasVision: true },
  { value: '@cf/moonshotai/kimi-k2.5',                      label: 'Kimi K2.5',       desc: 'Frontier open model with 256k context, vision & multi-turn tools', icon: 'moonshotai.svg', tier: 'advanced', hasVision: true },
  { value: '@cf/moonshotai/kimi-k2.6',                      label: 'Kimi K2.6',       desc: 'Frontier 1T MoE model with 262k context, vision & multi-turn tools', icon: 'moonshotai.svg', tier: 'advanced', hasVision: true },
  { value: '@cf/moonshotai/kimi-k2.7-code',                 label: 'Kimi K2.7 Code',   desc: 'Frontier 1T coding model with 262k context, vision & agentic tools', icon: 'moonshotai.svg', tier: 'advanced', hasVision: true },
];
